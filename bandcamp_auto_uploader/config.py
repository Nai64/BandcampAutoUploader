...
class Config:
    ...
    undo_hotkey: str = "Ctrl+Z"  # Hotkey for the Undo action on the track table
    ...
    context_menu_replace_file: bool = False  # Show Replace File option
    ...
    context_menu_revert_to_original: bool = False  # Show Revert to Original option
    context_menu_extract_tracklist: bool = False  # Show Extract Tracklist option
    context_menu_open_session: bool = False  # Show Open session.txt option
    context_menu_set_track_cover_as_album_cover: bool = False  # Show Set Track Cover as Album Cover option
    context_menu_undo: bool = True  # Show Undo option
    context_menu_redo: bool = True  # Show Redo option
    context_menu_extract_track_info: bool = False  # Show Extract Track Information option
    context_menu_lock_unlock: bool = True  # Show Lock/Unlock option
    context_menu_randomize: bool = False  # Show Randomize option
    context_menu_smart_randomize: bool = False  # Show Smart Randomize option
    ...
    context_menu_clear_metadata: bool = False  # Show Clear Metadata option
    ...
    extract_embedded_cover_art: bool = False  # Extract and use embedded cover art from each track
