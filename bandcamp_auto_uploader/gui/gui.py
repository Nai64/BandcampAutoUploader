...
class BandcampUploaderGUI(SettingsMixin, LogsMixin):
    ...
    def create_upload_tab(self, parent):
        ...
        desc_cube = tk.Frame(self.details_frame, bg="#ffffff", highlightthickness=1, highlightbackground="#a0a0a0")
        desc_cube.pack(fill=tk.X, pady=(0, 2))
        self.desc_text = tk.Text(desc_cube, height=2, wrap=tk.WORD, font=("Segoe UI", 8),
            relief=tk.FLAT, borderwidth=0, highlightthickness=0)
        self.desc_text.pack(fill=tk.BOTH, expand=True)
        self.desc_text.configure(bg="#ffffff")
        ...
        credits_cube = tk.Frame(self.details_frame, bg="#ffffff", highlightthickness=1, highlightbackground="#a0a0a0")
        credits_cube.pack(fill=tk.X, pady=(0, 2))
        self.credits_text = tk.Text(credits_cube, height=2, wrap=tk.WORD, font=("Segoe UI", 8),
            relief=tk.FLAT, borderwidth=0, highlightthickness=0)
        self.credits_text.pack(fill=tk.BOTH, expand=True)
        self.credits_text.configure(bg="#ffffff")
        ...
        td_desc_cube = tk.Frame(self.track_details_frame, bg="#ffffff", highlightthickness=1, highlightbackground="#a0a0a0")
        td_desc_cube.pack(fill=tk.X, pady=(0, 2))
        self.td_desc_text = tk.Text(td_desc_cube, height=2, wrap=tk.WORD, font=("Segoe UI", 8),
            relief=tk.FLAT, borderwidth=0, highlightthickness=0)
        self.td_desc_text.pack(fill=tk.BOTH, expand=True)
        self.td_desc_text.configure(bg="#ffffff")

        ttk.Label(self.track_details_frame, text="Lyrics:", font=("Segoe UI", 8, "bold")).pack(anchor=tk.W, pady=(0, 1))
        td_lyrics_cube = tk.Frame(self.track_details_frame, bg="#ffffff", highlightthickness=1, highlightbackground="#a0a0a0")
        td_lyrics_cube.pack(fill=tk.X, pady=(0, 2))
        self.td_lyrics_text = tk.Text(td_lyrics_cube, height=2, wrap=tk.WORD, font=("Segoe UI", 8),
            relief=tk.FLAT, borderwidth=0, highlightthickness=0)
        self.td_lyrics_text.pack(fill=tk.BOTH, expand=True)
        self.td_lyrics_text.configure(bg="#ffffff")

        ttk.Label(self.track_details_frame, text="Credits:", font=("Segoe UI", 8, "bold")).pack(anchor=tk.W, pady=(0, 1))
        td_credits_cube = tk.Frame(self.track_details_frame, bg="#ffffff", highlightthickness=1, highlightbackground="#a0a0a0")
        td_credits_cube.pack(fill=tk.X, pady=(0, 2))
        self.td_credits_text = tk.Text(td_credits_cube, height=2, wrap=tk.WORD, font=("Segoe UI", 8),
            relief=tk.FLAT, borderwidth=0, highlightthickness=0)
        self.td_credits_text.pack(fill=tk.BOTH, expand=True)
        self.td_credits_text.configure(bg="#ffffff")
